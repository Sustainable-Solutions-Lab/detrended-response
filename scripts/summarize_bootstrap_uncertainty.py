...
def plot_combined_uncertainty_bars(
    ...
    RESPONSE_TYPE_INFO = {
        ...
        'T': ('Three-Interval', ['h2', 'T_opt', 'h4'], '[°C$^{-1}$]'),
        'D': ('Persistence', ['h2', 'T_opt', 'h4'], '[year$^{-1}$]'),
        'L': ('Level', ['h2', 'T_opt'], None),
    }
    RESPONSE_TYPE_DISPLAY_ORDER = ['Q', 'P', 'S', 'T', 'D', 'L']
...
def generate_approach_summary_latex(
    ...
    all_rows = [
        ...
        ('Approach TJ', 'TJ'), ('Approach TP', 'TP'), ('Approach TL', 'TL'),
    ...
    section_header_text = {
        ...
        'T': r'\multicolumn{5}{l}{\textit{Three-interval response}} \\',
