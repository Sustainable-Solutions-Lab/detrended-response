...
def generate_tables(
    ...
    # Note: approach_summary.tex is generated by summarize_bootstrap_uncertainty.py
    # (Step 4 in the main pipeline), which also computes the width comparisons
    # needed for significance stars.
